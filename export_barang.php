...
$total_akhir_hpp = 0;
    ...
    $perintah = $db->query("SELECT s.nama AS satuan_konversi ,b.nama_barang,b.kode_barang,b.harga_beli,b.harga_jual,b.harga_jual2,b.id,b.harga_jual3,b.berkaitan_dgn_stok,b.stok_barang,b.satuan,b.kategori,b.gudang FROM barang b LEFT JOIN satuan s ON b.satuan = s.id WHERE b.berkaitan_dgn_stok = 'Barang'  ORDER BY b.id DESC");
